...
$sql = "SELECT SUM(total_charges) AS total_sum FROM billing_details";
...
$today = date('Y-m-d');
 ...
 $sql1 = "SELECT SUM(total_charges) AS today_earnings 
...
$sql2 = "SELECT SUM(total_charges) AS monthly_earnings 
FROM billing_details 
...
if ($result && $result1) {
    ...
    $today_earnings = $row1['today_earnings'];

    $row2 = $result2->fetch_assoc();
    $monthly_earnings = $row2['monthly_earnings'];
...
.back {
  /* background-image:url('https://www.careerguide.com/career/wp-content/uploads/2021/05/2-3.gif');
...
<body>
  ...
  <div class="main-content back" style="padding: 0;">
    ...
    <div class="container " style="margin-top: 50px;">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="card scale mb-3" style="max-width: 540px;">
                                <div class="row g-0">
                                  <div class="col-md-4">
                                    
                                    <!-- <img src="images/doctor2.jpg" class="img-fluid rounded-start" alt="..."> -->
                                    <i class=" fa-solid fa-money-check-dollar fa-xs mt-4" style="padding: 20px; font-size: 60px;color:#B197FC"></i>  
                                  </div>
                                  <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="col-sm-4">
                            <div class="card scale mb-3" style="max-width: 540px;">
                                <div class="row g-0">
                                  ...
                                  <div class="col-md-8">
                                    <div class="card-body">
                                      <h5 class="card-title" style="color: purple;">EARNING (Montly)</h5>
                                      <p>$<?php echo $monthly_earnings ;?></p>
                                ...
                                <div class="row g-0">
                                  ...
                                  <div class="col-md-8">
                                    <div class="card-body">
                                      ...
                                      <p>Today's earnings: $<?php echo $today_earnings; ?></p>
