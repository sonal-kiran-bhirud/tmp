...
if(isset($_POST['submit'])){
    ...
    $sql = "SELECT * FROM `patients` WHERE aadhar = '$aadhar'";  
    ...
    if($row){
        ...
        header('location:billsview.php');
        exit(); 
    } else {
        echo "Please enter a valid Aadhar number";
    }
}
?>
...
<body>
  ...
  <div class="main-content" style="padding: 0;">
    ...
    <h4 style="text-align:center">Generate Bill </h4>
  
      <form method="post" action="">
        <div class="row">
          <div class="col-sm-6">
        
          <label for="aadhar">Enter Aadhar Number:</label><br>
          ...
          <div class="align-item-center">
            <button type="submit" name="submit" id="submit" class="btn btn-primary button">Generate Bill
    </div>
    </div>
      </form>
